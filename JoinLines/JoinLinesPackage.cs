//------------------------------------------------------------------------------
// <copyright file="JoinLinesPackage.cs" company="Company">
...
namespace JoinLines
{
    ...
    [Guid(JoinLinesPackage.PackageGuidString)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    public sealed class JoinLinesPackage : Package
    {
        /// <summary>
        /// JoinLinesPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "cd28a771-8c83-4f85-887e-bb0576f1da45";

        /// <summary>
        /// Initializes a new instance of the <see cref="JoinLines"/> class.
        /// </summary>
        public JoinLinesPackage()
        {
